...
**SkyN3t** is a multi-agent orchestration system that coordinates multiple AI agents, tracks their work, stores what they learn, and exposes the system through a CLI and a FastAPI web dashboard.

> This file includes Mermaid diagrams and renders best in GitHub or another Mermaid-compatible markdown viewer.
